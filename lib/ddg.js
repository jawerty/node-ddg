...
// Library of fields that the DuckDuckGo API supports
...
function getURL(query, options) {
	const URL = "https://api.duckduckgo.com/?q="+encodeURIComponent(query)+"&format="+options.format+"&t="+encodeURIComponent(options.useragent)+"&pretty="+options.pretty+"&no_redirects="+options.no_redirects+"&no_html="+options.no_html+"&skip_disambig="+options.skip_disambig;
	return URL;
}
